...
struct ContentView: View {
    ...
    @State private var editingItem: SyllabankItem?
    ...
    private func row(for item: SyllabankItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: SyllabankItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
